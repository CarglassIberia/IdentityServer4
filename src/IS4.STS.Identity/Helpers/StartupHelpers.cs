...
using IS4.STS.Identity.Configuration.Constants;
...
namespace IS4.STS.Identity.Helpers
{
    public static class StartupHelpers
    {
            ...
            where TUserIdentity : class where TUserIdentityRole : class
        {
            ...
            {
                var certificate = CertificatesHelpers.GetSigningCertificateFromFile(configuration["cert:fullname"], configuration["cert:password"]);
